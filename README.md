...
Refer **Payment** app and test file `test_views.py` for more.

A few examples below clear it better. Transaction model refers to Currency model. When we create a instance of Transaction then an instance of Currency is automatically created as saved in DB. This makes a unit test case a integration test case. Lets see how we dealt with it.
...
```python
    def test_list(self, mocker, rf):
        ...
        # mocked queryset behave just like actual one
        qs = MockSet(
